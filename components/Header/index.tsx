        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                <div className="logo-cont dark:hidden">
                  <Image
                    src="/images/logo/logo-2.svg"
                    alt="logo"
                    width={140}
                    height={30}
                    className="new-logo w-full "
                  />
                  <h4 className="logo-text-dark">Pricescraper</h4>
                </div>
                <div className="logo-cont">
                  <Image
                    ...
                    width={140}
                    height={30}
                    className="new-logo hidden w-full dark:block"
                  />
                  <h4 className="logo-text">Pricescraper</h4>
                </div>
              </Link>
            </div>
