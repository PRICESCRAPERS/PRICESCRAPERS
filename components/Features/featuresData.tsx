...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      'Transformando tus ideas en soluciones tecnológicas personalizadas y eficientes. Nuestro equipo de expertos en desarrollo de software trabaja en estrecha colaboración contigo para entender tus necesidades y diseñar soluciones adaptadas a tu negocio. Desde aplicaciones web y móviles hasta sistemas empresariales escalables, creamos software de alta calidad que impulsa tu éxito. Maximiza tu productividad, optimiza tus procesos y supera a la competencia con nuestro servicio de software a medida. Descubre el poder de la innovación tecnológica en tus manos.',
  },
  {
    id: 1,
    icon: (
    ...
    title: 'Diseño UX',
    paragraph:
      ' Elevando la experiencia de tus usuarios al siguiente nivel. Enfocados en la interacción y la usabilidad, nuestro equipo de expertos en diseño UX crea experiencias digitales cautivadoras y memorables. Desde interfaces intuitivas hasta diseños visuales impactantes, nos esforzamos por brindar soluciones que generen conexiones emocionales y deleiten a tus usuarios. Utilizando las últimas tendencias y mejores prácticas en diseño, transformamos tus ideas en interfaces atractivas y funcionales. Con nuestro enfoque centrado en el usuario, tu marca se destacará y cautivará a tu audiencia, generando lealtad y aumentando la satisfacción.',
  },
  {
    id: 1,
    icon: (
    ...
    title: 'Big data',
    paragraph:
      'Desbloqueando el potencial oculto en tus datos. Nuestro equipo de expertos en Big Data está preparado para aprovechar el poder de tus datos y convertirlos en información valiosa para tu empresa. A través de técnicas avanzadas de recolección, almacenamiento y análisis de datos, desentrañamos patrones, tendencias y conocimientos ocultos que pueden impulsar la toma de decisiones estratégicas. Con tecnologías de vanguardia y algoritmos inteligentes, transformamos datos complejos en información significativa y accionable. Ya sea que necesites optimizar tus operaciones, personalizar la experiencia del cliente o identificar nuevas oportunidades de crecimiento.',
  },
  {
    id: 1,
    icon: (
    ...
    title: 'Asesoramiento',
    paragraph:
      'Guiándote hacia el éxito empresarial. Nuestro equipo de expertos en consultoría está listo para brindarte orientación estratégica y asesoramiento personalizado. Analizamos minuciosamente tus necesidades y objetivos empresariales para ofrecerte recomendaciones sólidas y soluciones adaptadas a tu empresa. Evaluamos tus servicios y métodos existentes, identificamos áreas de mejora y te proporcionamos un plan de acción detallado para optimizar tu rendimiento. Lo mejor de todo, nuestra evaluación es completamente gratuita. Descubre cómo nuestro asesoramiento experto puede impulsar tu negocio hacia el éxito y llevarlo al siguiente nivel',
  },
  {
    id: 1,
    icon: (
